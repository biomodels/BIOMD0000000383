...
`pip install git+https://github.com/biomodels/BIOMD0000000383.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000383.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000383 as model`
...
**Note:** Model of the Calvin cycle with focus on the RuBisCO reaction by Farquhar et al. (1980, [DOI:10.1007/BF00386231](http://dx.doi.org/10.1007/BF00386231) ). 
